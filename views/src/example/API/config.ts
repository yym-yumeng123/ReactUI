...
export const Api_Data_Table = [
  ...
  {
    props: "changeSeletedItems",
    explain: "开启多选, 选中数据的变化",
  ...
  {
    props: "expandable",
    explain: "展开详情, 配合 columns 的 description 属性使用",
    type: "boolean",
    defaultValue: "false",
    require: "false",
  },
  ...
  },
  {
    props: "render",
    explain: "渲染对应字段",
    type: "(text: string, record: T, index: number) => ReactElement",
    defaultValue: "",
    require: "false",
  },
  {
